...
setup(
  ...
  version = '1.57',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/SarthakJShetty/pyResearchInsights/archive/v_157.tar.gz',    # I explain this later on
